...
<\/script> -->`])), maybeRenderHead(), "MedBlog", renderComponent($$result, "Icon", $$Icon, { "href": "/seacrh", "size": 30, "name": "search" }));
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>MedBlogs</title><link rel="stylesheet" href="/styles.css">${renderHead()}</head> <body class="flex flex-col justify-center" data-astro-cid-sckkx6r4> <div class="flex flex-col min-h-screen mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 container" data-astro-cid-sckkx6r4> ${renderComponent($$result, "Navbar", $$Navbar, { "data-astro-cid-sckkx6r4": true })} <main class="flex-grow" data-astro-cid-sckkx6r4> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "VisualEditing", $$VisualEditing, { "enabled": visualEditingEnabled, "zIndex": 1e3, "data-astro-cid-sckkx6r4": true })} </main> </div> </body></html>`;
